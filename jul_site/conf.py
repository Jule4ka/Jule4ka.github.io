...
BLOG_AUTHOR = "Julia Paranich"  # (translatable)
BLOG_TITLE = "Juuul site"  # (translatable)
...
BLOG_EMAIL = "jpjul13@ggamil.com"
BLOG_DESCRIPTION = "Random thoughts on any topic I consider interesting"  # (translatable)
